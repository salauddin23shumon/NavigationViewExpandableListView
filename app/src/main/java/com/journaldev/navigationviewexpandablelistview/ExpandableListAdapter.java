...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        try {
            listDataChild.get(this.listDataHeader.get(groupPosition)).get(0);
        }
        catch (Exception ex)
        {
            check = true;
        ...
        if(isExpanded)
        {
            arrow_iv.setImageResource(R.drawable.ic_remove_black_10dp);
        }
        else
        {
            arrow_iv.setImageResource(R.drawable.ic_add_black_10dp);
        }

        if (groupPosition==2){
            arrow_iv.setImageResource(R.drawable.ic_menu_camera);
        }
        if (groupPosition==2){
